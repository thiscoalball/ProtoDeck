...
class DesktopNavigationSidebar extends StatelessWidget {
  ...
  static const _categories = ['网络诊断', 'Wi‑Fi', '性能', 'IP 与子网', '远程连接', '编码与开发'];
  ...
  /// Tools are opened with an imperative MaterialPageRoute inside the shell.
  /// On desktop the sidebar remains visible, so `context.go('/tools')` alone
  /// is a no-op while that child route is still covering the tools page.
