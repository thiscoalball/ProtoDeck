...
const networkToolStringsEn = <String, ToolCopy>{
  ...
  'ntp': ToolCopy('NTP Query', 'Clock offset, round-trip delay, and stratum'),
  'ports': ToolCopy('Port Check', 'Scan one port, a list, or a bounded range'),
  'lan': ToolCopy('LAN Scanner', 'Discover online hosts and common services'),
  ...
  'packet_capture': ToolCopy(
    ...
    'Inspect PCAP / PCAPNG traffic and protocols',
  ),
