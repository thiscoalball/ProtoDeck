...
class $ToolDraftsTable extends ToolDrafts
    with TableInfo<$ToolDraftsTable, ToolDraft> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ToolDraftsTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'tool_drafts';
  @override
  VerificationContext validateIntegrity(
    Insertable<ToolDraft> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  ToolDraft map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ToolDraft(
  ...
  @override
  $ToolDraftsTable createAlias(String alias) {
    return $ToolDraftsTable(attachedDatabase, alias);
  }
}

class ToolDraft extends DataClass implements Insertable<ToolDraft> {
  final String scope;
  ...
  ToolDraftsCompanion toCompanion(bool nullToAbsent) {
    return ToolDraftsCompanion(
      scope: Value(scope),
  ...
  ToolDraft copyWithCompanion(ToolDraftsCompanion data) {
    return ToolDraft(
  ...
  @override
  int get hashCode => Object.hash(scope, schemaVersion, payloadJson, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ToolDraft &&
...
class ToolDraftsCompanion extends UpdateCompanion<ToolDraft> {
  final Value<String> scope;
  final Value<int> schemaVersion;
  final Value<String> payloadJson;
  final Value<DateTime> updatedAt;
  final Value<int> rowid;
  const ToolDraftsCompanion({
  ...
  ToolDraftsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       payloadJson = Value(payloadJson),
       updatedAt = Value(updatedAt);
  static Insertable<ToolDraft> custom({
  ...
  @override
  String toString() {
    return (StringBuffer('ToolDraftsCompanion(')
          ..write('scope: $scope, ')
          ..write('schemaVersion: $schemaVersion, ')
          ..write('payloadJson: $payloadJson, ')
          ..write('updatedAt: $updatedAt, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $ToolDraftsTable toolDrafts = $ToolDraftsTable(this);
  @override
...
typedef $$TransferJobsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$ToolDraftsTableCreateCompanionBuilder =
    ToolDraftsCompanion Function({
      required String scope,
      required int schemaVersion,
      required String payloadJson,
      required DateTime updatedAt,
...
typedef $$ToolDraftsTableUpdateCompanionBuilder =
    ToolDraftsCompanion Function({
      Value<String> scope,
      Value<int> schemaVersion,
      Value<String> payloadJson,
...
class $$ToolDraftsTableFilterComposer
    extends Composer<_$AppDatabase, $ToolDraftsTable> {
  $$ToolDraftsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ToolDraftsTableOrderingComposer
    extends Composer<_$AppDatabase, $ToolDraftsTable> {
  $$ToolDraftsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ToolDraftsTableAnnotationComposer
    extends Composer<_$AppDatabase, $ToolDraftsTable> {
  $$ToolDraftsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ToolDraftsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $ToolDraftsTable,
          ...
          $$ToolDraftsTableOrderingComposer,
          $$ToolDraftsTableAnnotationComposer,
          $$ToolDraftsTableCreateCompanionBuilder,
          $$ToolDraftsTableUpdateCompanionBuilder,
          (
            ToolDraft,
            BaseReferences<_$AppDatabase, $ToolDraftsTable, ToolDraft>,
          ),
          ToolDraft,
          PrefetchHooks Function()
        > {
  $$ToolDraftsTableTableManager(_$AppDatabase db, $ToolDraftsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ToolDraftsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ToolDraftsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ToolDraftsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
...
typedef $$ToolDraftsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $ToolDraftsTable,
      ToolDraft,
      ...
      $$ToolDraftsTableCreateCompanionBuilder,
      $$ToolDraftsTableUpdateCompanionBuilder,
      (ToolDraft, BaseReferences<_$AppDatabase, $ToolDraftsTable, ToolDraft>),
      ToolDraft,
      PrefetchHooks Function()
    >;
...
class $AppDatabaseManager {
  ...
  $$ToolDraftsTableTableManager get toolDrafts =>
      $$ToolDraftsTableTableManager(_db, _db.toolDrafts);
}
