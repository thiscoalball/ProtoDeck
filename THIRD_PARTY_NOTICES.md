...
### Noto Sans CJK SC documentation subset

- Component: `app/test/assets/ProtoDeckDocsCJKSubset.otf`
- Purpose: deterministic Simplified Chinese glyphs in generated documentation screenshots only
- Upstream: https://github.com/notofonts/noto-cjk
- Copyright: 2010-2012 Google Corporation
- License: SIL Open Font License 1.1
- Complete license: `app/test/assets/ProtoDeckDocsCJKSubset-LICENSE.txt`

The checked-in font is a subset containing the glyphs used by ProtoDeck's UI
sources. It is not bundled into application release artifacts.
